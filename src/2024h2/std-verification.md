...
only verify monomorphic code, while [Verus] extends the Rust language using macros.
...
Applying those techniques to the Standard library will allow us to assess different verification techniques,
identify where all these tools come short, and where more research needs to be done to
address those gaps.
